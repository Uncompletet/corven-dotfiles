...
hl.bind("SUPER + ALT + Space", hl.dsp.global("quickshell:overviewClipboardToggle"))
...
hl.bind("ALT + F4",
    ...
    { non_consuming = true })
hl.bind("SUPER + E", hl.dsp.window.close(), { description = "Window: Close" })
...
hl.bind("SUPER + Q", hl.dsp.exec_cmd(fileManager), { description = "App: File manager" })
